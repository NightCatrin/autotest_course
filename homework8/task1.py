...
def treatment_sum(our_tuple):
    """Функция возвращает сумму двух элементов кортежа
     Происходит проверка, что подаваемый кортеж состоит из двух элементов,
     что два элемента являются либо только числом, либо только строкой"""
